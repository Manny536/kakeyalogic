...
The manuscript supplies a bibliography for vector calculus, mimetic differences and sticky Kakeya geometry. Those references remain supplied background pointers in the author-held manuscript; this registration does not claim a fresh source-level verification or import their theorems into the custom state model.
